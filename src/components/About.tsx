  ...
  return (
    <div className="about-section" id="about">
      <div className="about-me">
        ...
        <p className="para">
          Hi, I'm a Software Developer focused on architecting high-performance, scalable systems. My expertise spans designing optimized database schemas, building secure RESTful APIs, and implementing state-driven user interfaces.
        </p>
